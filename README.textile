...
What's a REPL?  See the "Wikipedia article.":http://en.wikipedia.org/wiki/Read_Eval_Print_Loop
...
* Unity 2.6.1: Works.
* Unity/iPhone: See iPhone branch.  Functional, but limited UI.
* Unity 3.0.0: Use the "Unity3" branch.  Generally works (tested in 3.0.0b4), but due to a change in event semantics, I've had to change how the enter key is handled to work around an error for now.  I'm investigating.
...
** Make things like 'quit' inaccessible.
