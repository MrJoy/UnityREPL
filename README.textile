...
<b>Please note that all instructions assume that you are using Unity 2.6.x, or 3.0!</b>
...
<i>If you are using Unity/iPhone 1.x, you will need to use one of the other installation methods below.</i>
...
__If you are using Unity/iPhone 1.x, replace the line @git checkout master@ with @git checkout iPhone@.__
...
* Unity 3.0.0: Works.  Use the "master" branch.
...
[Package]http://github.com/downloads/MrJoy/UnityREPL/UnityREPL_0.6.unitypackage