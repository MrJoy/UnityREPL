...
Tested on Unity 5.2.2, but may work on slightly earlier versions.
...
All original/novel code is Copyright (c) 2009-2015 Jon Frisby.  All other code is the property of the respective authors.
